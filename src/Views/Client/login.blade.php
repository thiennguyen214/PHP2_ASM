...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('/assets/admin/') }}fonts/font-awesome-4.7.0/css/font-awesome.min.css" />
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="{{ asset('/assets/admin/') }}images/team.jpg" alt="IMG" />
                </div>
                <!--=====TIÊU ĐỀ======-->
                <div class="login100-form validate-form">
                    ...
                    <form action="{{ url('handle-login') }}" method="post">
                        <div class="wrap-input100 validate-input">
                            <input class="input100" type="email" placeholder="Tài khoản quản trị" name="email"
                                id="email" required />
                    ...
                    <div class="text-center p-t-70 txt2">
                        ...
                        <a class="txt2" href="https://www.facebook.com/truongvo.vd1503/">
                            Code bởi Thiện
                        </a>
                    </div>
                </div>
