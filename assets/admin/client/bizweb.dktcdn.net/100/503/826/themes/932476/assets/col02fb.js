...
if (wDWs < 991) {
	...
	$('.tab-filter').add('.aside-filter .close-filter').click(function(){
		$('.dqdt-sidebar').addClass('openf');
		$('.opacity_sidebar').addClass('openf');
		$('#sort-by').addClass('d-none');
		$('.filter-container-tow .aside-item').removeClass('d-none');
		$('.filter-container__selected-filter').removeClass('d-none');
	});
	$('.tab-sort').add('.aside-filter .close-filter').click(function(){		
		$('.dqdt-sidebar').addClass('openf');
		$('.opacity_sidebar').addClass('openf');
		$('#sort-by').removeClass('d-none');
		$('.filter-container-tow .aside-item').addClass('d-none');
...
$(document).click(function(e){
	if (!$(e.target).hasClass('aside-item')){
		$(".aside-hidden-mobile .aside-item").removeClass("active");
		$("#sort-by").removeClass("active");
	}
});